import { Body, Controller, Delete, Get, HttpStatus, ParseFilePipeBuilder, Post, Query, UploadedFiles, UseGuards } from '@nestjs/common';
...
export class AdminFilesController {
  ...
  @ApiDocumentResponse({ status: HttpStatus.UNPROCESSABLE_ENTITY, message: 'File is required', model: UploadBadRequestDoc })
  ...
  @ApiDocumentResponse({ status: HttpStatus.BAD_REQUEST, message: 'Param id must be an UUID value', model: DeleteFileBadRequestDoc })
  ...
  bulkDelete(@Body() bulkDeleteFileDto: BulkDeleteDto) {
