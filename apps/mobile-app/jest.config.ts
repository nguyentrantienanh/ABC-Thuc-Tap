...
const jestConfig: JestConfigWithTsJest = {
  ...
  moduleNameMapper: {
    ...
    '^@repo/shared-universal/(.*)$': '<rootDir>/../../packages/shared-universal/$1',
    '^@repo/react-native-design-system/(.*)$': '<rootDir>/../../packages/react-native-design-system/$1',
    '^@repo/react-native-ui-core/(.*)$': '<rootDir>/../../packages/react-native-ui-core/$1',
  },
