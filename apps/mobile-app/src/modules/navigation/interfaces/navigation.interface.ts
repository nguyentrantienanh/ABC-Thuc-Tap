...
export type AuthenticatedNavigationProps = CompositeNavigationProp<
  ...
  CompositeNavigationProp<DrawerNavigationProp<TravelDrawerParamList>, BottomTabNavigationProp<TravelBottomTabParamList>>
>;
...
export type UnauthenticatedStackProps<T extends keyof UnauthenticatedParamList> = StackScreenProps<UnauthenticatedParamList, T>;
...
export type ProfileStackProps<T extends keyof ProfileParamList> = CompositeScreenProps<StackScreenProps<ProfileParamList, T>, RestProps>;
...
export type TravelExploreStackProps<T extends keyof ExploreParamList> = CompositeScreenProps<StackScreenProps<ExploreParamList, T>, RestProps>;

export type TravelTourStackProps<T extends keyof TourParamList> = CompositeScreenProps<StackScreenProps<TourParamList, T>, RestProps>;
